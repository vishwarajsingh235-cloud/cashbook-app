...
export async function GET() {
  try {
    ...
    doc.fillColor('#64748b').fontSize(8.5).font('Helvetica').text('Phone: +91 9258089101', 85, 52);
    ...
    // Divider Line
    doc.moveTo(30, 85).lineTo(565, 85).lineWidth(1).strokeColor('#cbd5e1').stroke();
    ...
    doc.fillColor('#16a34a').font('Helvetica-Bold').text('52,000.00', 470, y + 5, { width: 85, align: 'right' });

    // Footer
    doc.fontSize(8).fillColor('#64748b').font('Helvetica').text('* Computer Generated Statement. Powered by CashLedger', 30, 795);
