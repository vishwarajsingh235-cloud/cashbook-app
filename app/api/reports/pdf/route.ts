  ...
  try {
    ...
    const pdfHtml = `
      ...
      <style>
        ...
        body { font-family: Arial, sans-serif; color: #0f172a; margin: 0; padding: 15px; border: 2px solid #0f172a; box-sizing: border-box; }
        .header { display: flex; justify-content: space-between; border-bottom: 2px solid #0f172a; padding-bottom: 12px; }
        .logo { width: 45px; height: 45px; background: #0f172a; color: #38bdf8; font-size: 20pt; font-weight: 900; text-align: center; line-height: 45px; border-radius: 8px; display: inline-block; }
        .brand { display: inline-block; margin-left: 10px; vertical-align: top; }
        .title { font-size: 15pt; font-weight: 800; text-transform: uppercase; margin: 0; }
        .sub { font-size: 8.5pt; color: #64748b; font-weight: 600; }
        .doc-title { font-size: 16pt; font-weight: 900; color: #0284c7; text-align: right; margin: 0; }
      ...
      <body>
        <div class="header">
          ...
          <div>
            ...
            <div class="sub" style="text-align: right;">Date: ${new Date().toLocaleDateString('en-IN')}</div>
          </div>
        </div>
